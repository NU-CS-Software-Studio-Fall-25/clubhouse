...
class GoogleCalendarService
  ...
  def create_event(*args)
    Rails.logger.info("[GoogleCalendarService] create_event called but Calendar API is disabled.")
    nil
  end

  def list_events(*args)
    Rails.logger.info("[GoogleCalendarService] list_events called but Calendar API is disabled.")
    []
  end
end